...
void select_devices(struct piranha_audio_device *adev)
{
    int i;
                  ...
                  const XML_Char **attr)
{
    ...
    struct piranha_dev_cfg *dev_cfg;
...
static int adev_config_parse(struct piranha_audio_device *adev)
{

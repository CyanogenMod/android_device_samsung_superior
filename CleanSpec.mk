...
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/superior/obj/SHARED_LIBRARIES/libaudio_intermediates)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/superior/obj/STATIC_LIBRARIES/libasound_intermediates)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/superior/obj/EXECUTABLES/alsa_*)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/superior/system/bin/alsa_*)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/superior/system/etc/asound.conf)
